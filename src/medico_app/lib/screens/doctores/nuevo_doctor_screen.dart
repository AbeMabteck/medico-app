...
class NuevoDoctorScreen extends StatefulWidget {
  const NuevoDoctorScreen({super.key});

  @override
  State<NuevoDoctorScreen> createState() => _NuevoDoctorScreenState();
}

class _NuevoDoctorScreenState extends State<NuevoDoctorScreen> {
